...
//----- 헤더파일 열기
//
#define  HW_MULTIIMU_LOCAL


#include "Hw_MultiIMU.h"
#include "Hw_IMU.h"
#include "Lb_Printf.h"
#include "math.h"
...
/*---------------------------------------------------------------------------
     TITLE   : Hw_MultiIMU_Init
     WORK    : 
     ARG     : void
     RET     : void
---------------------------------------------------------------------------*/
void Hw_MultiIMU_Init( void )
{
	acc_1G = 512 * 8;
...
/*---------------------------------------------------------------------------
     ...
     RET     : void
---------------------------------------------------------------------------*/
void Hw_MultiIMU_Update( HW_IMU_DATA_OBJ *ptr_data ) 
{
    uint32_t axis;
